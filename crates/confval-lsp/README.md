...
This crate serves that surface to an editor: diagnostics, completion, hover, navigation, rename, document highlight, document symbols, path links, folding, and quick fixes.
